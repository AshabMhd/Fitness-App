  ...
  return (
    <div className="page-inner">
      ...
      <motion.div initial={{ opacity:0, y:20 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.6, delay:0.1 }} className="session-bar">
        ...
        <div style={{ marginTop:24, padding:'22px', borderRadius:24, background:'rgba(248,250,252,0.95)', border:'1px solid rgba(226,232,240,0.9)' }}>
            ...
            <div style={{ display:'flex', alignItems:'flex-start', justifyContent:'space-between', flexWrap:'wrap', gap:12 }}>
              ...
              <div style={{ display:'flex', gap:10, flexWrap:'wrap', alignItems:'center' }}>
                <input
                  ...
                  style={{ minWidth:180, padding:'10px 14px', borderRadius:14, border:'1px solid var(--border)', background:'white', color:'var(--text-primary)', fontSize:13 }}
                />
                <motion.button
                  whileHover={{ scale:1.03 }} whileTap={{ scale:0.97 }}
                  onClick={handleSavePlan}
                  disabled={!exercises.length || pendingSave}
                  style={{ padding:'12px 20px', borderRadius:9999, border:'none', background: !exercises.length || pendingSave ? 'rgba(107,114,128,0.16)' : '#1d4ed8', color:'white', fontWeight:700, cursor: !exercises.length || pendingSave ? 'not-allowed' : 'pointer' }}
                >
                  Save Plan
                </motion.button>
              </div>
              ...
              <div style={{ display:'flex', flexDirection:'column', gap:10 }}>
                ...
                <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:10 }}>
                  <input
                    ...
                    style={{ padding:'10px 14px', borderRadius:14, border:'1px solid var(--border)', background:'white', color:'var(--text-primary)' }}
                  />
                  <select
                ...
                <textarea
                  ...
                  rows={3}
                  style={{ padding:'10px 14px', borderRadius:14, border:'1px solid var(--border)', background:'white', color:'var(--text-primary)', resize:'vertical' }}
                />
                <motion.button
                  whileHover={{ scale:1.03 }} whileTap={{ scale:0.97 }}
                  onClick={handleCreateCustomWorkout}
                  style={{ padding:'12px 22px', borderRadius:9999, border:'none', background:'#2563eb', color:'white', fontWeight:700, cursor:'pointer', alignSelf:'flex-start' }}
                >
                  Add Custom Workout
                </motion.button>
                {customError && <div style={{ color:'#dc2626', fontSize:13 }}>{customError}</div>}
              </div>
              <div style={{ display:'flex', flexDirection:'column', gap:10, padding:'16px', borderRadius:20, background:'white', minWidth:220 }}>
